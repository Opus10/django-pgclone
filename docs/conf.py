# -*- coding: utf-8 -*-
#
# django-pgclone documentation build configuration file, created by
...
htmlhelp_basename = 'django-pgclonedoc'
...
latex_documents = [
    (
        master_doc,
        'django-pgclone.tex',
        u'django-pgclone Documentation',
        u'Opus 10',
        'manual',
    )
]
